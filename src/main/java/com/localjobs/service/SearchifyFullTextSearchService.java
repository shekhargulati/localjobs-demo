...
public class SearchifyFullTextSearchService implements FullTextSearchService {
    ...
    public void addToIndex(String documentId, Map<String, String> fields) {
        try {
            ...
            throw new RuntimeException("Exception occured while adding document to index .. ", e);
        }
    }
    ...
    public Set<String> search(String query) {
        ...
        try {
            ...
            throw new RuntimeException("Exception occured while searching for results with query " + query, e);
        }
        return documentIds;
    }
