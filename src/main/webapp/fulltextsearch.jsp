...
<body>
	...
	<div class="container-narrow">
		...
		<sec:authorize access="isAuthenticated()">
			<ul class="nav nav-pills">
				...
				<li class="active"><a href="${pageContext.servletContext.contextPath}/fulltextsearch">Full Text Search</a></li>
			</ul>
		</sec:authorize>
	...
	<script src="${pageContext.servletContext.contextPath}/resources/js/fulltextsearch.js"></script>
